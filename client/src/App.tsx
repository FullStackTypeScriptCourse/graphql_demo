...
const App = () => {
    const [task, setTask] = useState<ITask>({id: "", level: "", title: "", studyPoints: 0} );
    ...
    <>
        ...
        <Route path="/" element={<Header toggleModal={toggleModal}/>}>
            ...
            <Route path="/admin/create/task" element={
              <NonComponent name="Admin: Create Task"/>
            } />
            <Route path="/admin/view/users" element={
              <NonComponent name="Admin: view users"/>
            } />
            <Route path="/admin/view/tasks" element={
              <TaskTable data={getTasksQuery.data.tasks} columns={["Level","Title","Study Points","Operations"]} title="Show all tasks" setTask={setTask} deleteTask={deleteTask}/>
            } />
            <Route path="/user/view/stats" element={
